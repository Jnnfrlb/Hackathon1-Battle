     ...
     <div class="container">
       ...
       <div class="row accueil">
         ...
         <div class="card col-3 offset-2">
           ...
           <div class="card-body">
             <h5 class="card-title"><?php echo "<h5>".$tabMystique['name']."</h5><br/>"."<progress value=".$life1." max=\"1000\"></progress><br>"; ?></h5>
           </div>
         </div>
         ...
         <div class="card col-3">
           ...
           <div class="card-body">
             <h5 class="card-title"><?php echo "<h5>".$tabWonderWoman['name']."</h5><br/>"."<progress value=".$life2." max=\"1000\"></progress><br>"; ?></h5>
           </div>
         </div>
      ...
      <div class="accueil message">
        <?php
          while ($life1 > 0 && $life2 > 0) {
              ...
              echo "Le vainqueur est ". $tabWonderWoman['name']. ", il lui reste " .$life2."pts de vie."."<br>" . $tabMystique['name'] ." est mouru !";

          }else{
              echo "Le vainqueur est ". $tabMystique['name']. ", il lui reste " . $life1." pts.<br>" .$tabWonderWoman['name'] ." est mouru !";
          }
         ?>
      </div>
      <br><br>
       <div class="bouton">
         <a href="battleMystique.php" class="btn btn-primary btn-primary2">Restart !</a>
       </div>
       <br><br>
