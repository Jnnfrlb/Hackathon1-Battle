     ...
     <div class="container">
       ...
       <div class="row accueil">
         ...
         <div class="card col-3 offset-2">
           ...
           <div class="card-body">
             <h5 class="card-title"><?php echo "<h5>".$tabYoda['name']."</h5><br/>"."<progress value=".$life1." max=\"1000\"></progress><br>"; ?></h5>
           </div>
         </div>
         ...
         <div class="card col-3">
           ...
           <div class="card-body">
             <h5 class="card-title"><?php echo "<h5>".$tabMaul['name']."</h5><br/>"."<progress value=".$life2." max=\"1000\"></progress><br>"; ?></h5>
           </div>
         </div>
      ...
      <div class="accueil message">
        <?php
          while ($life1 > 0 && $life2 > 0) {
              ...
              echo "Le vainqueur est ". $tabMaul['name']. ", il lui reste " .$life2."pts de vie."."<br>" . $tabYoda['name'] ." est mouru !";

          }else{
              echo "Le vainqueur est ". $tabYoda['name']. ", il lui reste " . $life1." pts.<br>" .$tabMaul['name'] ." est mouru !";
          }
         ?>
      </div>
      <br><br>
       <div class="bouton">
         <a href="battleYoda.php" class="btn btn-primary btn-primary2">Restart !</a>
       </div>
       <br><br>
