      ...
      <div class="accueil message">
        <?php
          while ($life1 > 0 && $life2 > 0) {
              ...
              echo "Le vainqueur est ". $tabStormtrooper['name']. ", il lui reste " .$life2."pts de vie."."<br>" . $tabJarjar['name'] ." est mouru !";

          }else{
              echo "Le vainqueur est ". $tabJarjar['name']. ", il lui reste " . $life1." pts.<br>" .$tabStormtrooper['name'] ." est mouru !";
          }
         ?>
      </div>
      <br><br>
       <div class="bouton">
         <a href="battleJarJar.php" class="btn btn-primary btn-primary2">Restart !</a>
       </div>
       <br><br>
