     ...
     <div class="container">
       ...
       <div class="row accueil">
         ...
         <div class="card col-3 offset-2">
           ...
           <div class="card-body">
             <h5 class="card-title"><?php echo "<h5>".$tabSauron['name']."</h5><br/>"."<progress value=".$life1." max=\"1000\"></progress><br>"; ?></h5>
           </div>
         </div>
      ...
      <div class="accueil message">
        <?php
          while ($life1 > 0 && $life2 > 0) {
              ...
              echo "Le vainqueur est ". $tabThor['name']. ", il lui reste " .$life2."pts de vie."."<br>" . $tabSauron['name'] ." est mouru !";

          }else{
              echo "Le vainqueur est ". $tabSauron['name']. ", il lui reste " . $life1." pts.<br>" .$tabThor['name'] ." est mouru !";
          }
         ?>
      </div>
      <br><br>
       <div class="bouton">
         <a href="battleSauron.php" class="btn btn-primary btn-primary2">Restart !</a>
       </div>
       <br><br>
